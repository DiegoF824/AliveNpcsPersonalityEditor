...
public sealed class GalleryPane
{
    ...
    public void Draw(SpriteBatch b)
    {
        ...
        EditorTheme.DrawButton(b, _discoverButton, _i18n.Get("tab.discover"), _mode == 0 ? Active : Paper, Color.Black);
        EditorTheme.DrawButton(b, _localButton, _i18n.Get("tab.local"), _mode == 1 ? Active : Paper, Color.Black);

        _serverButton = new Rectangle(area.Right - 150, area.Y, 150, DiscoverH);
        EditorTheme.DrawButton(b, _serverButton, _i18n.Get("gallery.server.button"), Paper, Color.Black);
        ...
        EditorTheme.DrawButton(b, _searchButton, _i18n.Get("gallery.browse.search"), Paper, Color.Black);
    ...
    private void DrawServerEditor(SpriteBatch b)
    {
        ...
        EditorTheme.DrawButton(b, _urlCancelButton, _i18n.Get("button.cancel"), new Color(225, 125, 85), Color.Black);
        EditorTheme.DrawButton(b, _urlSaveButton, _i18n.Get("button.save"), new Color(120, 190, 100), Color.Black);
    }
    ...
    private void DrawNpcDropdown(SpriteBatch b)
    {
        ...
        if (maxScroll > 0)
            EditorTheme.DrawScrollbar(b, inner, _npcDropScroll, maxScroll);
    }
    ...
    private void DrawCards(SpriteBatch b)
    {
        ...
        if (_maxScroll > 0)
            EditorTheme.DrawScrollbar(b, layout.GridArea, _scrollY, _maxScroll);
    }
...
public sealed class GalleryPreviewModal
{
    ...
    public void Draw(SpriteBatch b)
    {
        ...
        EditorTheme.DrawBorder(b, portraitRect, new Color(125, 60, 40), 4);
    ...
    private void DrawFields(SpriteBatch b)
    {
        ...
        _scrollY = Math.Clamp(_scrollY, 0, _maxScroll);
        if (_maxScroll > 0)
            EditorTheme.DrawScrollbar(b, _textArea, _scrollY, _maxScroll);
    }
