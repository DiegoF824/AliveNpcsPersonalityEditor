...
internal static class EditorTheme
{
    ...
    {
        DrawBorder(b, rect, Color.DarkGoldenrod * 0.7f, thickness, Game1.fadeToBlackRect);
    }

    /// <summary>Draw a solid border inside <paramref name="rect"/>.</summary>
    public static void DrawBorder(SpriteBatch b, Rectangle rect, Color color, int thickness, Texture2D? texture = null)
    {
        var pixel = texture ?? Game1.staminaRect;
    ...
    {
        DrawBorder(b, card, CdAccent, thickness, Game1.fadeToBlackRect);
