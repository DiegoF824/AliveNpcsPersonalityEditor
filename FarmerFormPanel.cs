...
public sealed class FarmerFormPanel
{
    ...
    public void Draw(SpriteBatch b)
    {
        ...
        EditorTheme.DrawButton(b, _cancelBtn, _i18n.Get("button.cancel"), BtnReset, Color.Black);
        EditorTheme.DrawButton(b, _saveGalleryBtn, _i18n.Get("button.save_gallery"), BtnGallery, Color.Black);
        EditorTheme.DrawButton(b, _saveBtn, _i18n.Get("button.save"), BtnSave, Color.Black);
    }
